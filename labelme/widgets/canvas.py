...
class Canvas(QtWidgets.QWidget):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.shapes = []
        self.shapesBackups = []
        self.isAuto = False     # by hw1230 (current shapes is auto)
        self.isAutoBackup = []        # by hw1230 (isAuto backup list)
        self.current = None
    ...
    def storeShapes(self):
        assert len(self.shapesBackups) == len(self.isAutoBackup)
        shapesBackup = []
        for shape in self.shapes:
            shapesBackup.append(shape.copy())
        if len(self.shapesBackups) > self.num_backups:
            self.shapesBackups = self.shapesBackups[-self.num_backups - 1 :]
            self.isAutoBackup = self.isAutoBackup[-self.num_backups - 1 :]
        self.shapesBackups.append(shapesBackup)
        self.isAutoBackup.append(self.isAuto)
        self.isAuto = False
    ...
    def restoreShape(self):     # return value added by hw1230
        assert len(self.shapesBackups) == len(self.isAutoBackup)
        ...
        ia = self.isAutoBackup.pop()   # by hw1230

        # The application will eventually call Canvas.loadShapes which will
        # push this right back onto the stack.
        shapesBackup = self.shapesBackups.pop()
        isAuto = self.isAutoBackup.pop()    # by hw1230
        self.shapes = shapesBackup
        self.isAuto = isAuto                # by hw1230
        self.selectedShapes = []
        for shape in self.shapes:
    ...
    def removeSelectedPoint(self):
        shape = self.prevhShape
        point = self.prevMovePoint
        if shape is None or point is None or shape.shape_type == "rectangle":
            return False
    ...
    def setLastLabel(self, text, flags):
        ...
        self.isAuto = self.isAutoBackup.pop()
        self.storeShapes()
